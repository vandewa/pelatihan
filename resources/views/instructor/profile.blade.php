                        ...
                        <div class="tab-pane fade show active" id="information" role="tabpanel"
                            ...
                            <div class="widget-body">
                                ...
                                <div class="form-group row d-flex align-items-center mb-5">
                                    <label
                                        class="col-lg-2 form-control-label d-flex justify-content-lg-end">@translate(Email)</label>
                                    <div class="col-lg-6">
                                ...
                                <div class="form-group row d-flex align-items-center mb-5">
                                    <label
                                        class="col-lg-2 form-control-label d-flex justify-content-lg-end">@translate(Nik)</label>
                                    <div class="col-lg-6">
