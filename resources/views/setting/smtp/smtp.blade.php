    ...
    <div class="col-lg-7">
        <div class="card mb-3">
            <div class="card-header">
                <h3 class="card-title">@translate(Pengaturan SMTP)</h3>
            </div>
            <div class="card-body">
    ...
    <div class="col-lg-5">
        <div class="panel bg-gray-light">
            <div class="panel-body">
                ...
                <ul class="list-group">
                    <li class="list-group-item text-dark">@translate(Select 'sendmail' for Mail Driver if you face any
                        issue after configuring 'smtp' as Mail Driver )
                    </li>
                    <li class="list-group-item text-dark">@translate(Set Mail Host according to your server Mail Client
                        Manual Settings)
                    </li>
                    <li class="list-group-item text-dark">@translate(Set Mail port as '587')</li>
                    <li class="list-group-item text-dark">@translate(Set Mail Encryption as 'ssl' if you face issue with
                        'tls')
                    </li>
                </ul>
                <hr>
