...
<div class="row">
    <div class="col-md-6">
        <div class="card mb-3">
            <div class="card-header">
                <h2 class="card-title">@translate(List Bahasa)</h2>
            </div>
                ...
                <table class="table table-striped- table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="kt-nav__link-icon"><img src="{{asset('uploads/lang/'.$item->image)}}"
                                        class="" height="30px" alt="" /></span>
                            </td>
                            <td>
                                <div class="kanban-menu">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right action-btn"
                                            ...
                                            <a class="dropdown-item" href="{{route('language.translate',$item->id)}}">
    ...
    <div class="col-md-6">
        <div class="card mb-3">
            <div class="card-header">
                <h3 class="card-title">@translate(Pengaturan Bahasa)</h3>
            </div>
            <div class="card-body">
                <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('language.store') }}"
                    ...
                    <div class="form-group">
                        <div class="">
                            <label class="control-label">@translate(Nama) <span class="text-danger">*</span></label>
                        </div>
                        <div class="">
                            <input type="text" class="form-control" name="name" required
                                placeholder="@translate(Ex: Indonesia)">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="">
                            <label class="control-label">@translate(Kode) <span class="text-danger">*</span></label>
                        </div>
                        <div class="">
                            <input type="text" class="form-control" name="code" required
                                placeholder="@translate(Ex: id untuk Indonesia)">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="control-label">@translate(Pilih Negara) <span class="text-danger">*</span></label>
                        <div class="">
                            <select class="form-control lang" name="image" required>
                                <option value=""></option>
                                @foreach(readFlag() as $item)
                                @if ($loop->index >1)
                                <option value="{{$item}}" data-image="{{asset('uploads/lang/'.$item)}}">
                    ...
                    <div class="form-group">
                        <div class="col-lg-12 text-right">
                            <button class="btn btn-primary btn-block" type="submit">@translate(Simpan)</button>
                        </div>
                    </div>
                </form>
            </div>
