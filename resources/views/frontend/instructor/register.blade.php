            ...
            <div class="col-lg-8 mx-auto">
                <div class="card-box-shared">
                    <div class="card-box-shared-title text-center">
                        <h3 class="widget-title font-size-35">@translate(Buat Akun dan) <br> @translate(Mulai Buat
                            Pelatihan)!</h3>
                    </div>
                        ...
                        <div class="contact-form-action">
                            <form method="post" action="{{ route('instructor.create') }}">
                                ...
                                <div class="row">
                                            ...
                                            <label>
                                                ...
                                                <div class="post-card text-center">
                                                    <div class="post-card-content">
                                                        <img src="{{filePath($item->image)}}" alt=""
                                                            class="img-fluid" />
                                                        ...
                                                        <div>
                                                            ...
                                                            <h3 class="text-info text-dark"> {{$item->commission}} %
                                                            </h3>
                                                            @translate(of the course price for each enrollment of that
                                                            course)
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-lg-12 ">
                                        <div class="btn-box">
                                            <button class="theme-btn" type="submit">@translate(Register
                                                account)</button>
                                        </div>
                                    </div><!-- end col-md-12 -->
                                    <div class="col-lg-12">
                                        <p class="mt-4">@translate(udah memiliki akun)? <a href="{{ route('login') }}"
