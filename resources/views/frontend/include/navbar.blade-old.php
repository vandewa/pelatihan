                            ...
                            <form>
                                <div class="input-box">
                                    <div class="form-group">
                                        ...
                                        {{--some ajax value--}}
                                        <input value="@translate(Your Cart is Empty)" type="hidden" id="emptyUrl"
                                            name="emptyUrl">
                                    ...
                                    <div class="notification-item mr-3 cart_item">
                                        ...
                                        <div id="mySidebar" class="cart-sidebar">
                                            ...
                                            <div class="cart_sidebar">
                                                ...
                                                <input value="@translate(Go To Cart)" type="hidden" id="textUrl"
                                                    name="textUrl">
                                                ...
                                                <div id="cartBtn">
                                                    <a href="{{route('course.filter')}}"
                                                        class="theme-btn cart-btn btn-cart cart-text f-13 w-50">@translate(Get
                                                        Your Course)</a>
                                                </div>
                                                ...
                                                <ul class="list-group">
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="{{ route('student.dashboard') }}"
                                                            class="cart-btn btn-cart cart-text notify-btn f-13 w-50 mt-3">@translate(See
                                                            all notifications)</a>
                                            ...
                                            <div class="cart_sidebar">
                                                ...
                                                <div id="cartBtn">
                                                    <a href="{{ route('my.wishlist') }}"
                                                        class="theme-btn cart-btn cart-text w-75">@translate(Show All
                                                        Wishlist)</a>
                                                </div>
                                                        ...
                                                        <ul class="list-items">
                                                            ...
                                                            <li class="mb-0">
                                                                <a href="{{ route('dashboard') }}" class="d-block">
                                                                    <i class="la la-dashboard"></i> @translate(Go To
                                                                    Dashboard)
                                                                </a>
                                                            </li>
                                                        ...
                                                        <ul class="list-items">
                                                            ...
                                                            <li class="mb-0">
                                                                <a href="{{route('tickets.index')}}" class="d-block">
                                                                    <i class="la la-ticket"></i> @translate(Support
                                                                    Ticket)
                                                                </a>
                                                            </li>
                        ...
                        <div class="side-nav-container">
                            ...
                            <div class="side-menu-wrap">
                                ...
                                <div class="side-btn-box">
                                    ...
                                    <span>or</span>
                                    <a href="{{ route('student.register') }}" class="theme-btn">@translate(Register)</a>
                                </div>
                                @endguest
