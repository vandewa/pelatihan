                ...
                <div class="col-lg-12">
                    <div class="card-box-shared">
                        <div class="card-box-shared-title">
                            <h3 class="widget-title">@translate(Pesan)</h3>
                        </div>
                        <div class="card-box-shared-body">
                            <div class="row">
                                        ...
                                        <div class="message-content flex-grow-1">
                                            <div class="message-header">
                                                <div class="mess__item justify-content-between align-items-center">
                                                    <div class="d-flex">
                                                        <div class="avatar">
                                                            <img src="{{filePath($item->enrollCourse->relationBetweenInstructorUser->image)}}"
                                                                alt="">
                                                        </div>
                                                        <div class="content">
                                                            <h4 class="widget-title font-size-15 mb-0">
                                                                {{$item->enrollCourse->relationBetweenInstructorUser->name}}
                                                            </h4>
                                                            <span
                                                        ...
                                                        <div class="mess__body">
                                                            <div class="mess__item">
                                                                <div class="avatar">
                                                                    ...
                                                                    <img src="{{$mess->user->image != null ? filePath($mess->user->image) : asset('uploads/user/user.png') }}"
                                                                        alt="Michelle Moreno">
                                                                </div>
                                                                <div class="content">
                                                    ...
                                                    <form action="{{route('message.sent')}}" method="post">
                                                        ...
                                                        <div class="input-box d-flex align-items-center">
                                                            <div class="form-group flex-grow-1 mb-0">
                                                                <textarea class="message-control form-control mr-2"
                                                                    name="message"
                                                                    placeholder="@translate(Ketik pesan)"></textarea>
                                                                <button type="submit"
                                ...
                                @empty
                                <div class="col-12">
                                    <h3 class="text-center m-3">@translate(Tidak Ada Pesan)</h3>
                                </div>
                                @endforelse
                            </div>
                        </div>
