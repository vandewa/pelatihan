        ...
        <table class="table table-striped- table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if($item->video)
                        <a href="{{$item->video}}" target="_blank" class="nav-link">@translate(tampilkan link)</a>
                        @endif
                    </td>
                    <td>
                        @if($item->image != null)
                        <img src="{{filePath($item->image)}}" class="img-fluid avatar-lg rounded-sm">
                    </td>
                    @endif
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right action-btn"
                                    ...
                                    <a class="dropdown-item"
                                        onclick="confirm_modal('{{ route('know.destroy', $item->id) }}')" href="#!">
