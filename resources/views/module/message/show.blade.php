...
<div class="card m-2">
    <div class="card-header">
        <div class="float-left">
            <h2 class="card-title">@translate(Chat Dengan Siswa)</h2>
        </div>
    </div>
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="media">
                            <img class="align-self-center mr-3 text-center rounded-circle" height="auto" width="100"
                                src="{{asset($student->image ?? 'assets/images/users/girl.svg')}}" alt="image">
                        </li>
                    </ul>
                </div>
                <div class="chat-body">
                        ...
                        <form action="{{route('messages.replay')}}" method="post">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="message"
                                    ...
                                    placeholder="@translate(Ketik pesan...)" aria-label="Text"
                                    value="{{old('message')}}">
