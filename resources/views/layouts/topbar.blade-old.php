                            ...
                            <div class="dropdown">
                                <a class="dropdown-toggle" href="#" role="button" id="languagelink"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span
                                        class="live-icon">
                                        {{Str::ucfirst(\Illuminate\Support\Facades\Session::get('locale') ??
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="languagelink">
                                    ...
                                    <a class="dropdown-item" href="{{route('language.change')}}" onclick="event.preventDefault();
                                        ...
                                        <img width="25" height="auto" src="{{ asset(" uploads/lang/". $language->image)
                                        }}" alt=""/>
                                        {{$language->name}}</a>
                        ...
                        <div class="languagebar">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="languagelink">
                                    ...
                                    <form id="{{$item->code}}" class="d-none" action="{{ route('currencies.change') }}"
                                        method="POST">
                                        @csrf
                            ...
                            <div class="dropdown show">
                                ...
                                <div class="dropdown-menu dropdown-menu-right hide st-drop"
                                    ...
                                    <ul class="list-unstyled lms-notify">
                                        ...
                                        <li
                                            class="media dropdown-item {{ $notification->is_read === 0 ? 'bg-ecf0f1' : '' }}">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p><span class="timing">{{ $notification->created_at->diffForHumans()
                                                        }}</span></p>
                                            </div>
                                        </li>
                                        ...
                                        <li class="notification-dropdown-title stit-notification">
                                            <h5>
                                                @translate(Kamu tidak mempunyai notifikasi baru)
                                            </h5>
                                        </li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <a href="{{ route('mark_all_read', Auth::user()->id) }}"
                                                    class="stit-s-12">
                                                    @translate(Tandai semua sudah dibaca)</a>
                                            </div>
                                            @endif
                                        </div>
                                    </div>
                        ...
                        <div class="profilebar">
                            <div class="dropdown">
                                <a class="dropdown-toggle" href="#" role="button" id="profilelink"
                                    ...
                                    <img src="{{ \Illuminate\Support\Facades\Auth::user()->image != null ? filepath(\Illuminate\Support\Facades\Auth::user()->image)  : asset('/assets/images/users/profile.svg')}}"
                                        class="img-fluid rounded-circle avatar-sm" alt="profile">
                                    ...
                                    <div class="dropdown-item">
                                        <div class="profilename">
                                            <h5>
                                                ...
                                                {{formatPrice(instructorDetails(\Illuminate\Support\Facades\Auth::id())->balance)}}
                                            </h5>
                                        </div>
                                    </div>
                                    @endif
                                    <div class="userbox">
                                        <ul class="list-unstyled mb-0">
                                            ...
                                            <li class="media dropdown-item">
                                                <a href="{{ route("
                                                    instructors.edit",Illuminate\Support\Facades\Auth::user()->id) }}"
                                                    class="profile-icon">
                                            ...
                                            <li class="media dropdown-item">
                                                <a href="{{ route("
                                                    users.show",Illuminate\Support\Facades\Auth::user()->id) }}"
                                                    class="profile-icon">
                                                    <img src="{{asset('assets/images/svg-icon/crm.svg')}}"
                                                        class="img-fluid" alt="user">
