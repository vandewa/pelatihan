...
<section class="breadcrumb-section">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h2>@translate(Verifikasi )</h2>
                <div class="breadcrumb-link margin-top-10">
                    <span><a href="{{url('/')}}">@translate(home)</a> / @translate(Verifikasi )</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="login-form">
                    ...
                    <form class="d-inline" method="POST" action="{{ route('send.verify.token') }}">
                        ...
                        <button type="submit" class="btn btn-link p-0 m-0 align-baseline">@translate(click here to
                            request another)
                        </button>
                            ...
                            <div class="card-box-shared">
                                ...
                                <div class="card-box-shared-body">
                                    ...
                                    <form class="d-inline" method="POST" action="{{ route('send.verify.token') }}">
                                        ...
                                        <button type="submit"
                                            class="btn btn-link p-0 m-0 align-baseline">@translate(click here to request
                                            another)
                                        </button>
