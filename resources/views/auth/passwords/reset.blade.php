                    ...
                    <div class="card-box-shared-body contact-form-action">
                        <form method="POST" action="{{ route('password.update') }}">
                            ...
                            <div class="form-group">
                                <label for="email" class="col-form-label text-md-right">@translate(Alamat Email)</label>
                            ...
                            <div class="form-group">
                                <label for="password-confirm" class="col-form-label text-md-right">@translate(Konfirmasi
                                    Password)</label>
                    ...
                    <div class="card-box-shared">
                        ...
                        <div class="card-box-shared-body contact-form-action">
                            <form method="POST" action="{{ route('password.update') }}">
                                ...
                                <div class="form-group">
                                    <label for="email" class="col-form-label text-md-right">@translate(Alamat
                                        Email)</label>
                                ...
                                <div class="form-group ">
                                    <label for="password"
                                        class="col-form-label text-md-right">@translate(Password)</label>
                                ...
                                <div class="form-group">
                                    <label for="password-confirm"
                                        class="col-form-label text-md-right">@translate(Konfirmasi
                                        Password)</label>
